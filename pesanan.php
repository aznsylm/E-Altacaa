...
$query = mysqli_query($conn, 'SELECT tabel_pesanan.*,username, SUM(harga*jumlah) AS harganya FROM tabel_pesanan
    LEFT JOIN tabel_user ON tabel_user.id_user = tabel_pesanan.pelayan 
    LEFT JOIN tabel_list_pesanan ON tabel_list_pesanan.pesanan = tabel_pesanan.id_pesanan
    LEFT JOIN tabel_daftar_menu ON tabel_daftar_menu.id = tabel_list_pesanan.menu
    GROUP BY id_pesanan');
while ($record = mysqli_fetch_array($query)) {
    $result[] = $record;
}

// $select_kategori_menu = mysqli_query($conn, "SELECT id_kategori_menu,kategori_menu FROM tabel_kategori_menu");
